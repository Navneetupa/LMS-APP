...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white py-10">
      <div className="max-w-screen-xl mx-auto px-6 md:px-16 flex flex-col items-center">
  ...
  <div className="max-w-2xl mx-auto">
    <form className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full">
      <input
        ...
        className="flex-1 px-6 py-2 rounded-full border border-gray-300 bg-transparent focus:outline-none focus:ring-2 focus:ring-blue-600 text-white w-full"
      />
      <button
        type="submit"
