  ...
  return (
    <section className="py-20 bg-white px-4 sm:px-8 md:px-12 lg:px-16 relative">
      <div className={modalOpen ? "filter blur-sm pointer-events-none" : ""}>
        ...
        <p className="text-center text-cyan-900 max-w-3xl mx-auto mb-10 text-base md:text-lg px-2">
        ...
        <div className="flex justify-center mt-12">
          <button
            ...
            className="px-8 py-3 bg-[#49BBBD] text-white rounded-full font-semibold text-lg hover:bg-cyan-600 transition-colors duration-300 shadow-lg"
          >
