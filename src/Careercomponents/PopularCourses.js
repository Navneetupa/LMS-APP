...
const courses = [
  {
    ...
    students: "5.2K+ enrolled",
  },
  {
    title: "UI/UX Design Fundamentals",
    description: "Learn user-centered design with Figma and Adobe XD.",
    image: "https://img.icons8.com/color/96/design.png",
    students: "3.7K+ enrolled",
  },
  {
    title: "Python for Beginners",
    description: "Kickstart your coding journey with Python.",
    image: "https://img.icons8.com/color/96/python--v1.png",
    students: "7.1K+ enrolled",
  },
  {
    title: "Digital Marketing Mastery",
    description: "Become a digital marketing pro with SEO, SEM & social media.",
    // Fixed image URL:
    image: "https://img.icons8.com/color/96/digital-marketing.png",
    students: "4.8K+ enrolled",
  },
  {
    title: "Data Science with R",
    description: "Analyze data and create visualizations using R.",
    image: "https://img.icons8.com/color/96/data-science.png",
    students: "2.9K+ enrolled",
  },
  {
    title: "Cloud Computing Basics",
    description: "Learn cloud services and infrastructure management.",
    image: "https://img.icons8.com/color/96/cloud.png",
    students: "3.1K+ enrolled",
  },
  {
    title: "Cybersecurity Essentials",
    description: "Protect systems with cybersecurity fundamentals.",
    image: "https://img.icons8.com/color/96/cyber-security.png",
    students: "4.5K+ enrolled",
  },
  {
    title: "Machine Learning A-Z",
    description: "Explore machine learning algorithms and projects.",
    image: "https://img.icons8.com/color/96/machine-learning.png",
    students: "6.3K+ enrolled",
  },
  {
    title: "React JS Advanced",
    description: "Build modern web apps using React hooks and context.",
    image: "https://img.icons8.com/color/96/react-native.png",
    students: "5.0K+ enrolled",
  },
  {
    title: "Graphic Design Masterclass",
    description: "Create stunning visuals with Adobe Photoshop & Illustrator.",
    image: "https://img.icons8.com/color/96/graphic-design.png",
    students: "3.4K+ enrolled",
  },
  {
    title: "SQL & Database Management",
    description: "Master database queries and administration.",
...
const PopularCourses = () => {
  ...
  // Show only first 4 courses initially
  ...
  return (
    <section className="py-20 bg-white px-6 md:px-16 relative">
      <div className={modalOpen ? "filter blur-sm pointer-events-none" : ""}>
        {/* Yeh content blur hoga jab modal open ho */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 max-w-7xl mx-auto">
          {previewCourses.map((course, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-cyan-50 to-white p-6 rounded-3xl shadow-md hover:shadow-xl transition-shadow duration-300 cursor-pointer flex flex-col items-center text-center"
            >
              <img
                src={course.image}
                alt={course.title}
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            {/* Close button with sticky position */}
            <button
